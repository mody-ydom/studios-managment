      ...
      >
        {prevPage && (
          <CustomButton
            ...
            onClick={() => {
              const type = user?.user_type === "customer" ? "customer" : "owner";
              return router.push(`/reservations/cancelled?page=${Number(router.query.page || 2) - 1}`);
            }
            }
          >
            Previous
        ...
        {nextPage && (
          <CustomButton
            ...
            onClick={() => {
              const type = user?.user_type === "customer" ? "customer" : "owner";
              return router.push(`/reservations/cancelled?page=${Number(router.query.page || 1) + 1}`);
            }
            }
          >
            Next
